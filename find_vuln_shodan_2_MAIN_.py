...
file_path = "ZA_IOT_SSL_Filter.json"
vuln_file = "SHODAN/vulnerable_ZA_IOT_SSL_Filter_report.txt"
non_vuln_file = "SHODAN/non_vulnerable_ZA_IOT_SSL_Filter_report.txt"
